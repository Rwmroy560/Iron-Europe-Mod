...
NDiplomacy = {
	...
	EXILE_IMPRISONED_INTERACTION_ENABLED = 0,						-- Should this action be used at all?
...
NCharacter = {
	...
	CHANGE_AMBITION_YEARS = 2,						-- Delay between being able to pick a new ambition
	CHANGE_FOCUS_YEARS = 2,							-- Delay between being able to change focus
	...
	COURT_SIZE_CHILD_PENALTY_THRESHOLD = 50,
	...
	NATURAL_DEATH_CHANCE_AGE_70 = 300,				-- Natural deaths per decade out of 10000 people: Age 70-79
	NATURAL_DEATH_CHANCE_AGE_80 = 1500,				-- Natural deaths per decade out of 10000 people: Age 80-90
...
-- Title Grant Decadence Reduction (Multiplied with current decadence)
	...
	NORMAL_LAW_CHANGE_COUNCIL_MONTHS = 48,
	NORMAL_LAW_CHANGE_ABSOLUTISM_MONTHS = 60,
	MAX_CROWN_LAW_CHANGES = 1,
	CROWN_LAW_CHANGE_MONTHS = 36,
...
NMilitary = {
	...
	SUPPLY_CAPACITY = 60,						-- Amount of days of worth supply that a unit can hold.
